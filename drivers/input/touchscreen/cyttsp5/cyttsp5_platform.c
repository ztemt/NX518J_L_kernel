...
#define CYTTSP5_GW1_FIRMWARE_VERSION     0x1C02
...
*/
    ...
    switch (pdata->fw_ver_ic & 0xFF00) {
        case 0x0C00:
            ...
            /*For NX518JJ GW TP write FW from 0x0C0B to 0x1C01 */
            if (strcmp(ztemt_target,"NX518J") == 0) {
                dev_info(dev, "%s: For FW upgarde from 0C to 1C\n", __func__);
                pdata->fw_ver_dr = CYTTSP5_GW1_FIRMWARE_VERSION;
                return 1;
            }
            break;
 /*		case 0x0A00:

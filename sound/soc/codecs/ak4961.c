...
//add by zhangzhaoyang to control  hpfeedback_mic_gain 
 ...
 * */
static DECLARE_TLV_DB_SCALE(hpkaraoke_mic_gain_tlv, 000, 100, 0);
...
static int hpkaraoke_mic_gain = 0;
        ...
        struct snd_ctl_elem_value *ucontrol)
{
    ...
    val[4] = 0x01;
    val[5] = 0x02;
    val[6] = mic_gain_table[hpkaraoke_mic_gain] >> 16;
    val[7] = (mic_gain_table[hpkaraoke_mic_gain] >> 8) % 0x100;
    val[8] = mic_gain_table[hpkaraoke_mic_gain] % 0x100;
...
//add by zhangzhaoyang to control  hpfeedback_mic_gain 
    SOC_SINGLE_EXT_TLV("HP Feedback MIC Volume", SND_SOC_NOPM, 0, 20, 0,
            akm_hpfeedback_mic_gain_get,
            akm_hpfeedback_mic_gain_set, hpfeedback_mic_gain_tlv),
    SOC_SINGLE_EXT_TLV("HP Karaoke MIC Volume", SND_SOC_NOPM, 0, 20, 0,
            akm_hpkaraoke_mic_gain_get,
            akm_hpkaraoke_mic_gain_set, hpkaraoke_mic_gain_tlv),
//add by zhangzhaoyang to control  hpfeedback_mic_gain 
};
